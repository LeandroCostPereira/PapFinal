<div class="menu">
    ...
    <ul id="list">
        ...
        <li class="item"><a href="leilao.php" class="link"><img src="Imagens/Logo_montagem/Icons 24px/price_tag.png" alt=""> Leilão</a></li>
        <li class="item fec"><a href="iniciar_sessao.php" class="link "><img src="Imagens/Logo_montagem/Icons 24px/login.png" alt=""> Iniciar Sessão</a></li>
    </ul> 
</div>